...
try:
    ...
    # show a dialog that Python is needed
...
class Kilo_Antivirus(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.title("ThreatGuardian Antivirus")
        #self.resizable(False, False)
...
class Scan(tk.Frame):
    ...
    def scan_all_drives(self):
        ...
        for drive in drives:
            self.scan_drive(apiKey, drive)
    
    def scan_drive(self, apiKey, drive):
        url = "https://www.virustotal.com/vtapi/v2/file/scan"
        params = {'apikey': apiKey}
        files = {'file': (drive, open(drive, 'rb'))}
...
class Feedback(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        def submit():
            ...
            sender_email = "bella.thruster@gmail.com"  # Enter your address
